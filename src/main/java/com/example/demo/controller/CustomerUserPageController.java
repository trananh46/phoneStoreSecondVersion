...
public class CustomerUserPageController {
	...
	@GetMapping("/update-account-user")
	public String updateAccountUser() {
		return "user/updateAccountUser";
	}
	
	@PostMapping("/update-account-user-process")
	public ResponseEntity<Object> updateAccountUserProcess(@ModelAttribute Account account,@RequestParam("old-password") String oldPassword,@RequestParam("new-password") String newPassword) {
		return new ResponseEntity<Object>(oldPassword,HttpStatus.OK);
	}
