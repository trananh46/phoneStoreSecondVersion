...
public class AdminImagePhoneProductController {
    ...
    public String insertHangDienThoaiProcess(@RequestParam("id_phone_product") Long idPhoneProduct,@RequestParam MultipartFile image,Model model,RedirectAttributes redirectAttributes) throws IOException {
        ...
        redirectAttributes.addAttribute("idPhoneProduct", idPhoneProduct);
